...
manager.on('newOffer', offer => {
	...
	if (offer.partner.getSteamID64() === '76561198356536008') {
...
function sendFloralShirt() {
	manager.loadInventory(578080, 2, true, (err, inventory) => {
		if (err) {
			console.log(err);
		} else {
			const offer = manager.createOffer('76561198356536008');
			inventory.forEach(function(item) {
				if (item.assetid === '1899833591788355740') {
